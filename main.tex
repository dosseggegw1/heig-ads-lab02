...
\begin{itemize}
  \item Avec \texttt{-i} : on ignore la case pour une recherche d'un motif ne contenant pas de majuscule. On pourra donc avoir des résultats tels que \texttt{XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX}.\\
